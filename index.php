...
<body class="text-center">
  ...
  <div class="bot chat-block">
    ...
    <div id="chat-input">
        ...
        <button type="button" class="btn btn-primary" name="button" id="send-message">Ввод</button><a class="btn btn-default" href="https://bot.gexar.tk/app.php?get_message=10" target="_blank">Чат...</a>
    </div>
  </div>
